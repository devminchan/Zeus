...
public class TestMainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.second: {
                Intent intent = new Intent(TestMainActivity.this, FireInfoActivity.class);
                startActivity(intent);
                finish();
                break;
            }
            case R.id.third: {
                Intent intent = new Intent(TestMainActivity.this, EarthQuakeService.class);
                startActivity(intent);
                finish();
                break;
            }
