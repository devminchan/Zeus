...
public class EarthInfoActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.first: {
                Intent intent = new Intent(EarthInfoActivity.this, MainActivity.class);
                startActivity(intent);
                finish();
                break;
            }
            case R.id.second: {
                Intent intent = new Intent(EarthInfoActivity.this, FireInfoActivity.class);
                startActivity(intent);
                finish();
                break;
            }
